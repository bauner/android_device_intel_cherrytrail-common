...
# Kernel
BOARD_KERNEL_CMDLINE := loglevel=5 androidboot.hardware=cherrytrail firmware_class.path=/system/etc/firmware i915.fastboot=1 vga=current i915.modeset=1 drm.vblankoffdelay=1 enforcing=0 androidboot.selinux=disabled console=ttyS0,115200n8 bootboost=1 pm_suspend_debug=1 pstore.backend=ramoops thermal.off=1
